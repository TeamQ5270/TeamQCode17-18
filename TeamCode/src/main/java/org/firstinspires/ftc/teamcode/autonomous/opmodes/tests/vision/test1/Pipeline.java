...
public abstract class Pipeline implements CameraBridgeViewBase.CvCameraViewListener2 {
    static {
     ...
     */
    public void init(Context context, Display viewDisplay) {
     ...
     */
    public void init(Context context, Display viewDisplay, final int cameraIndex) {
